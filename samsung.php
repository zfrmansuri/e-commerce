...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/project1.0.png"  width="400px" height="350px" id="ProductImg">
            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="images/project1.0.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/product-1.1.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/project1.2.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/product1.3.png" width="170px" height="100px" class="small-img">
                </div>
            </div>
        </div>
        <div class="col-2">
            ...
            <p> 5G Ready powered by Qualcomm Snapdragon 865 Octa-Core processor, 8GB RAM, 128GB internal memory expandable up to 1TB, Android 11.0 operating system and dual SIM
                ...
                4500 mAh battery (Non -removable) with Super Fast Charging, FAst Wireless Charging & Finger Print sensor</p>
        </div>
    </div>
</div>
<!---------title--------->
