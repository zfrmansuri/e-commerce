...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/pods1.png"  width="400px" height="350px" id="ProductImg">
            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="images/pods1.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/pods1.1.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/pods1.2.png" width="170px" height="100px" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/pods1.3.png" width="170px" height="100px" class="small-img">
                </div>
            </div>
        </div>
        <div class="col-2">
            <p>Home /Mobile</p>
            <h2> Apple AirPods Pro (2nd Generation) ​​​​​​​
</h2>
            <h4>26,800\- Rs</h4>
            <!-- <select>
            ...
            <p>  Active Noise Cancellation reduces unwanted background noise
Adaptive Transparency lets outside sounds in while reducing loud environmental noise
Personalised Spatial Audio with dynamic head tracking places sound all around you</p>
        </div>
    </div>
</div>
<!---------title--------->
